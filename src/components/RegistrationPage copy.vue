      ...
      <div class="w-1/2 pr-8">
        ...
        <form class="space-y-4">
          <div>
            ...
            <input type="text" id="username" name="username" class="border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 block w-full py-2 px-3" required>
          </div>

          <div>
            <label for="email" class="block font-medium text-gray-700 mb-1">Email</label>
            <input type="email" id="email" name="email" class="border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 block w-full py-2 px-3" required>
          </div>

          <div>
            <label for="password" class="block font-medium text-gray-700 mb-1">Password</label>
            <input type="password" id="password" name="password" class="border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 block w-full py-2 px-3" required>
          </div>

          <div>
            <label for="confirm-password" class="block font-medium text-gray-700 mb-1">Confirm Password</label>
            <input type="password" id="confirm-password" name="confirm-password" class="border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 block w-full py-2 px-3" required>
          </div>

          <div>
            <label for="company-name" class="block font-medium text-gray-700 mb-1">Company Name</label>
            <input type="text" id="company-name" name="company-name" class="border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 block w-full py-2 px-3" required>
          </div>
          ...
          <div class="flex justify-between items-center">
            ...
            <a href="/login" class="text-indigo-500 hover:text-indigo-600 font-medium">Already Registered?</a>
          </div>
        </form>
...
export default {
  ...
  methods: {
    resetPassword() {
      ...
      console.log('Sending password reset email to:', this.forgotPasswordEmail);
